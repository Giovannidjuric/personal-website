      ...
      <div className="w-full h-[70%] flex">
        ...
        <div className="flex-grow flex flex-col">
          <div ref={slideRef} className="overflow-hidden flex">
            {QUOTES.map((quote, i) => {
              return (
                <div key={quote.id} className="text-3xl w-full flex-shrink-0">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic,
                  maiores. Impedit obcaecati rem quas. Quos at dolores vero
                  tempore enim hic autem porro commodi saepe fugit quo sit,
                  laborum excepturi.
                </div>
              );
            })}
